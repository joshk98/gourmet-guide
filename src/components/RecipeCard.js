...
const RecipeCard = ({ title, cuisine, prepTime, cookingTime, servings }) => {
  return (
    <div className="recipe-card" data-testid="recipe-card">
      ...
      <div className="recipe-card__prepTime">{prepTime}</div>
      <div className="recipe-card__cookingTime">{cookingTime}</div>
      <div className="recipe-card__servings">{servings}</div>
